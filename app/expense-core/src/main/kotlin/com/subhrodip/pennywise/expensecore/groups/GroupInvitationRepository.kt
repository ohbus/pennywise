...
interface GroupInvitationRepository : JpaRepository<GroupInvitationEntity, String> {
    ...
    /**
     * Atomically claims an unclaimed, unexpired invitation token for the given user subject.
     *
     ...
     * @return the number of updated rows (1 if claimed successfully, 0 if expired, invalid, or already claimed)
     */
