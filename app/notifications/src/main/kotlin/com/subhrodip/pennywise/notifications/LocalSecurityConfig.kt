...
/**
 * Local-profile security configuration for Notifications service that uses Spring's oauth2ResourceServer
 * with a passthrough [OpaqueTokenIntrospector] that accepts any Bearer token and uses it
 * literally as the principal name.
 *
 ...
 * the authenticated subject without any network call or signature validation.
 */
 ...
 * [java.security.Principal] for correct injection into `@AuthenticationPrincipal principal: Principal` params.
 */
